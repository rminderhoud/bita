...
impl std::fmt::Debug for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Error::UnknownChunkHasher => write!(f, "UnknownChunkHasher"),
            Error::UnknownSourceHasher => write!(f, "UnknownSourceHasher"),
            Error::RequestNotClonable => write!(f, "RequestNotClonable"),
...
impl std::fmt::Display for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Error::UnknownChunkHasher => write!(f, "unknown chunk hasher"),
            Error::UnknownSourceHasher => write!(f, "unknown source hasher"),
            Error::RequestNotClonable => write!(f, "request cannot be cloned"),
